...
REVOKE ALL ON DATABASE devstracker FROM devstracker;
GRANT CONNECT ON DATABASE devstracker TO devstracker;
GRANT USAGE ON SCHEMA devstracker TO devstracker;
