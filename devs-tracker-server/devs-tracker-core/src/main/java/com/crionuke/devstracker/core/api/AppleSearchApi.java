package com.crionuke.devstracker.core.api;

import com.crionuke.devstracker.core.api.dto.AppleSearchResponse;
...
public class AppleSearchApi {
    private static final Logger logger = LoggerFactory.getLogger(AppleSearchApi.class);
